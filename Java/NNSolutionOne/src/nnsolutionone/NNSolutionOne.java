...
class Connection
{
    ...
    public void setOutVal(double outVal) { m_outVal = outVal;}
    public double getOutVal() {return m_outVal;}
    //
...
//                * oldDeltaWeight;
    ...
    //class NNLayer {
    //    public ArrayList<Neuron> m_layer = new ArrayList<Neuron>();
    //}
    ...
    //        m_layers.get(num_neuron).get(numOp)
    //force bias neuron output to 0
    //        m_layers.back().back().setOutVal(0.0);
}
